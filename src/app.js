...
//2.0.0 加载model,一定是放在加载路由模块require('./routes/xxxx')之前
require('./model/videoInfo')
...
const forntRouter = require('./routes/Router')
...
// })
// app.get('/admin/videoInfo',require('./controllers/admin/videoInfoController'));
